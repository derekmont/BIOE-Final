...
pruner = tp.pruner.MetaPruner( # We can always choose MetaPruner if sparse training is not required.
    ...
    example_inputs,
    importance=imp,
    pruning_ratio=0.05, # remove 50% channels, ResNet18 = {64, 128, 256, 512} => ResNet18_Half = {32, 64, 128, 256}
    ignored_layers=ignored_layers,
)

base_macs, base_nparams = tp.utils.count_ops_and_params(model, example_inputs)
with open("results_prune_first_05.txt", "w") as f:
...
with open("results_prune_first_05.txt", "a") as f:
